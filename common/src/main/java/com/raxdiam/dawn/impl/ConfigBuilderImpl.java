...
import com.raxdiam.dawn.api.ConfigBuilder;
import com.raxdiam.dawn.api.ConfigCategory;
import com.raxdiam.dawn.api.Expandable;
import com.raxdiam.dawn.gui.AbstractConfigScreen;
import com.raxdiam.dawn.gui.DawnConfigScreen;
import com.raxdiam.dawn.gui.GlobalizedDawnConfigScreen;
...
public class ConfigBuilderImpl implements ConfigBuilder {
    ...
    private Component title = Component.translatable("text.dawn-config.config");
    ...
    public Screen build() {
        ...
        if (globalized) {
            screen = new GlobalizedDawnConfigScreen(parent, title, categoryMap, defaultBackground);
        } else {
            screen = new DawnConfigScreen(parent, title, categoryMap, defaultBackground);
        }

...
import com.raxdiam.dawn.api.animator.NumberAnimator;
import com.raxdiam.dawn.api.animator.ValueAnimator;
import com.raxdiam.dawn.math.Rectangle;
import com.raxdiam.dawn.math.impl.PointHelper;
...
import static com.raxdiam.dawn.api.scroll.ScrollingContainer.clampExtension;
import static com.raxdiam.dawn.api.scroll.ScrollingContainer.handleBounceBack;
...
public abstract class DynamicSmoothScrollingEntryListWidget<E extends DynamicEntryListWidget.Entry<E>> extends DynamicEntryListWidget<E> {
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double amount) {
        ...
        offset(DawnConfigInitializer.getScrollStep() * -amount, true);
        return true;
    }
    ...
    public void scrollTo(double value, boolean animated) {
        scrollTo(value, animated, DawnConfigInitializer.getScrollDuration());
    }
    ...
    public static class Interpolation {
        public static double expoEase(double start, double end, double amount) {
            return start + (end - start) * DawnConfigInitializer.getEasingMethod().apply(amount);
        }
    }

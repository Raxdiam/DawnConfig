...
import com.raxdiam.dawn.gui.registry.api.GuiRegistryAccess;
...
import com.raxdiam.dawn.gui.entries.MultiElementListEntry;
import com.raxdiam.dawn.gui.entries.NestedListListEntry;
import com.raxdiam.dawn.gui.entries.SelectionListEntry;
...
import static com.raxdiam.dawn.util.Utils.getUnsafely;
import static com.raxdiam.dawn.util.Utils.setUnsafely;
                        ...
                        ENTRY_BUILDER.startBooleanToggle(
                                ...
                                .setYesNoTextSupplier(bool -> {
                                    ...
                                    if (translate.equals(key))
                                        return Component.translatable("text.dawn-config.boolean.value." + bool);

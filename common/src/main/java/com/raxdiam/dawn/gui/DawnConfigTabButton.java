...
import com.raxdiam.dawn.api.Tooltip;
...
public class DawnConfigTabButton extends AbstractButton {
    
    private final int index;
    private final DawnConfigScreen screen;
    @Nullable
    private final Supplier<Optional<FormattedText[]>> descriptionSupplier;
    
    public DawnConfigTabButton(DawnConfigScreen screen, int index, int int_1, int int_2, int int_3, int int_4, Component string_1, Supplier<Optional<FormattedText[]>> descriptionSupplier) {
    ...
    public DawnConfigTabButton(DawnConfigScreen screen, int index, int int_1, int int_2, int int_3, int int_4, Component string_1) {
